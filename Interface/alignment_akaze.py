...
def mutual_inf(img1, img2, verbose=False):
    ...
    if verbose:
        ...
        if not os.path.exists("result"):
            os.makedirs("result")
        cv2.imwrite("result/joint_histogram.jpg", display_jh_resized.astype(np.uint8))
...
# -------------------------------------------------------------------------
# ---------------------- IMPLEMENTATION SÉPARÉE ---------------------------
# -------------------------------------------------------------------------

if __name__ == "__main__":

    I1 = cv2.imread("image1_path", cv2.IMREAD_GRAYSCALE)
    I2 = cv2.imread("image2_path", cv2.IMREAD_GRAYSCALE)
    ...
    print("Nombre de keypoints image 1 :", len(kpts1))
    print("Nombre de keypoints image 2 :", len(kpts2))
    ...
    print("Nombre de bonnes correspondances :", len(good_matches))
    ...
    cv2.imwrite("I2_corrected.jpg", I2_corrected)
